    ...
    <body>
        ...
        <div class="reg">
            <div v-if="isAuthenticated">
                ...
                <button @click="logout" class="submit">Выйти</button>
            </div>
        ...
        <!-- <form class="reg" method="post">
            <div>Имя: <input type="text" name="name" class="name"></div>
            <div>Пароль: <input type="text" name="password" class="password"></div>
            <div>Почта: <input type="text" name="email" class="email"></div>
